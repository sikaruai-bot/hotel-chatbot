...
async function main() {
  ...
  const settings = [
    ...
    { key: 'hotel_whatsapp', value: '+977-9818259472', category: 'CONTACT', description: 'Official WhatsApp support number' },
    ...
    { key: 'whatsapp_direct_url', value: 'https://wa.me/9779818259472', category: 'LINKS', description: 'Direct WhatsApp link' },
